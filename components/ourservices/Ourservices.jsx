...
export default function Ourservices() {
  return (
    <main className="min-h-screen section-block-padding">
      ...
      <div className="relative w-full flex flex-col mt-4 lg:flex-row items-center section-block-bottom">
        <img
      ...
      <div className="w-full flex flex-col section-block-padding container-padding mt-15 md:mt-0">
        <div className="bg-[#F5F5F5] mt-8 md:mt-0 p-8 md:p-12 flex flex-col md:flex-row gap-12">
          <div className="w-full md:w-[35%] flex justify-center">
            <img
